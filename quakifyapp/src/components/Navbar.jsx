...
const Navbar = () => {
  return (
    ...
    <div className='table-cell w-12 h-1'></div>
      <a href="/" className=" min-w-[171px] text-center table-fixed table-cell align-middle"><img alt="Logo"className='w-[122px] 2xl:w-[172px] h-[50px] 2xl:h-[71px] mt-0 pt-0'src="./logo.png"/></a>
